    ...
    <div className="pr-4">
      ...
      >
        ...
        <div className="flex flex-col">
          <h1 className="text-sm font-bold text-white leading-tight">SkillSpell</h1>
          <span className="text-[10px] font-medium text-slate-400 leading-tight">AI Skill Builder</span>
        </div>
      </button>
    </div>
  );
