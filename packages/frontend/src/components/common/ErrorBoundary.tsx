...
/**
 * React error boundary that catches component crashes and displays
    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex h-full flex-col items-center justify-center gap-4 p-8 text-center">
          ...
          {this.state.error && (
            <pre className="max-w-lg rounded-lg bg-red-50 p-3 text-left text-xs text-red-700 overflow-auto">
